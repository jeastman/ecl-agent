...
For this harness, skills are typically located at:
agents/primary-agent/skills/<skill-name>/
agents/subagents/<role>/skills/<skill-name>/

Example:
```python
uv run quick_validate.py agents/primary-agent/skills/my-skill
```
"""
